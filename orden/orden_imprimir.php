...
<table width="<?php echo $ancho_tabla; ?>" border="1" style="font-size:<?php echo $tamano_letra; ?>">
  ...
  <tr>
    ...
    <td>MOTO</td>
    <td><?php echo $arreglo_datos['placa'];?></td>
  </tr>
  <tr>
...
<table width="<?php echo $ancho_tabla; ?>" border="1" style="font-size:<?php echo $tamano_letra; ?>">
  <tr>
    <td width="601" rowspan="4">
    <!--	
	    <div id="condiciones">
	    	CONTRATO DE SERVICIO<BR>
		Autorizo Speed Desing a realizar las reparaciones aqui detalladas y suministrar los repuestos necesarios.
		<br>Speed Desing no responde en caso que las autoridades soliciten documentos de propiedad y estos no sean entregados oportunamente.
		<br>Speed Desing queda facultado para retener el vehiculo objeto de esta reparacion, hasta que los valores causados por las mismas sean cancelados en su totalidad. si despues de tres(3) dias de terminada la reparacion del vehiculo, este no es retirado , 
		Speed Desing cobrara por concepto de ocupacion de espacio de trabajo el valor de un(1) salario minimo diario vigente, 
		igualmente cuando la permanencia en el establecimiento sea por responsabilidad del cliente.
	    </div>
	   --> 
	</td>
