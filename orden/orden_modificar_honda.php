    ...
    <table border = "1"  width = "75%">
      <tr>
        ...
        <td >
         ...
         <input name="orden123" id = "orden123" type="hidden" size="20" value = "<? echo $datos[0]['orden']  ?>" > 
             </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input size=10 name=fecha id = "fecha"  value= <? echo $datos[0]['fecha']  ;?> disabled> 
        fecha entrega </td>
      ...
      <tr>
        <td>TELEFONO</td>
        <td colspan="2"><input name="telefono" id="telefono" type="text" size="40" value = "<? echo $datos[0]['telefonocli']  ?>" onfocus = "blur()"></td>
        <td>COLOR</td>
        <td><input name="color" type="text" size="20" value = "<? echo $datos[0]['color']  ?>"  disabled></td>
      </tr>
	   <tr>
	     <td>EMAIL</td>
	     <td width="214"><input name="email"  id="email"type="text" size="40" value = "<? echo $datos[0]['emailcli']  ?>" onfocus = "blur()"></td>
	     <td width="40">&nbsp;</td>
	  <td>KILOMETRAJE</td>
...
<div id = "div_inventario">	
  ...
  <!-- si el estqado es igual o mayor a 2 ya no debe mostrar mas el listado de estados-->
  <?php
  ...
  /////////////////////////////
   if ($datos[0]['estado']>=2)
   {
    //simplmente muestre el estado
      $datos_estado = consulta_assoc($tabla26,'valor_estado',$datos[0]['estado'],$conexion);
      echo $datos_estado['descripcion_estado'];
...
<?php
  }// fin de else de si el estado es mayor o igual a 2 
?>
	 </td>
	</tr>
	</table>
...
-->
<input type="button" id = "actualizar_orden"  value="ACTUALIZAR_INFORMACION" onClick="valida_envia()">
<?php
}//fin de si esle estado es entregada
?>
</h2> 
 </td>
</tr>
...
*/
          ...
          $("#actualizar_orden").click(function(){
              ...
              var data =  'id_orden=' + $("#orden_numero").val();
             ...
             // data += '&ultimo_estado=' + $("#ultimo_estado").val();
              //data += '&enviar_correo=' + $("#enviar_correo:checked").val();
              data += '&cambiar_placa=' + $("#cambiar_placa:checked").val();
