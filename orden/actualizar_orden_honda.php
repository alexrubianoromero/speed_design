...
$body= '
	   ...
	   Proximo Cambio Aceite: '.$_REQUEST['kilometraje_cambio'].' 
...
O envíanos un E-mail speeddesignmotolavadotaller@gmail.com<br>
Recuerda, estamos ubicados en 
	';
	//echo '<br>Se enviara el correo de que esta lista <br>';
...
function actualizar_contador_recibosysaldo_y_campo_orden($conexion,$tabla10,$numero,$suma,$id_orden,$tabla14){
	...
	///////////////////////modificacion especial para speed_desing- que ponga el saldo de la orden en cero 
	$sql_poner_saldo_orden_cero = "update $tabla14 set saldo =  '0'    where id = '".$_REQUEST['id_orden']."'  ";
	$con_saldo_cero = mysql_query($sql_poner_saldo_orden_cero,$conexion);
