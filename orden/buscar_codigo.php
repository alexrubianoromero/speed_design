...
$sql_traer_codigos = "select * from $tabla12 where descripcion like '%".$_REQUEST['descricodigo']."%'   ";
$consulta_codigos = mysql_query($sql_traer_codigos,$conexion);

//echo '<br>'.$sql_traer_codigos;
echo "<select name='codigo_a_escoger' id='codigo_a_escoger' class='fila_llenar' size='10' >";
