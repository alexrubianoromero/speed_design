...
$sql_traer_codigos = "select * from $tabla12 where marca like '%".$_REQUEST['descricodigo']."%' ";
$consulta_codigos = mysql_query($sql_traer_codigos,$conexion);

echo "<select name='marca_a_escoger' id='marca_a_escoger' class='fila_llenar' size='10' >";
