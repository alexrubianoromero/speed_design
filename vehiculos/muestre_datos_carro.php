...
<table width="976" border="1">
  ...
  <tr>
    <td>PLACA </td>
    <td><input name="placa" id  = "placa" type="text"  value = "<?php  echo $datos[0]['placa']?> "  onfocus = "blur()"><input type="checkbox" name="cambio_placa" id = "cambio_placa" value="1">
      <label for ="cambio_placa">CAMBIAR PLACA </label><div id="pida_placa"><input type="text" name ="nueva_placa" id ="nueva_placa" placeholder="NUEVA PLACA" class="fila_llenar"" size="7"></div></td>
  </tr>
  <tr>
    <td>PROPIETARIO</td>
 ...
 <div>
  ...
  <tr>
    <td ><button type ="button"  id = "actualizar_carro" ><h3>Actualizar</h3></button></td>
	 <td ><a href="eliminar_datos_vehiculo.php?idcarro=<?php echo $datos[0]['idcarro']; ?>&placa=<?php echo $_REQUEST['placa'];   ?>">ELIMINAR VEHICULO</a> </td>
    </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
