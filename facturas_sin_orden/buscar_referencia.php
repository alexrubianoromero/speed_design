...
$sql_traer_codigos = "select * from $tabla12 where referencia like '%".$_REQUEST['descricodigo']."%'  and id_empresa = '".$_SESSION['id_empresa']."'  ";
$consulta_codigos = mysql_query($sql_traer_codigos,$conexion);

echo "<select name='referencia_a_escoger' id='referencia_a_escoger' class='fila_llenar' multiple= 'multiple' >";
